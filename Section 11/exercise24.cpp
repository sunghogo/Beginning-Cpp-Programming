...
void print_grocery_list(size_t mangos = 13, size_t apples = 3, size_t oranges = 7);
...
void print_grocery_list(size_t mangos, size_t apples, size_t oranges) { //----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
                                     //----DO NOT MODIFY THE CODE BELOW THIS LINE----
    cout << apples << " apples" << "\n" << oranges << " oranges" << "\n" << mangos << " mangos" << "\n";
}
