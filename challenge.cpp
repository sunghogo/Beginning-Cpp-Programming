...
void display_menu();
void prompt_input(string prompt, char &input);
void prompt_input(string prompt, int &input);
void print_list(const vector<int> &list);
void add_number_to_list(vector<int> &list);
void calculate_mean_from_list(vector<int> &list);
void find_smallest_from_list(vector<int> &list);
void find_largest_from_list(vector<int> &list);
...
int main() {
    ...
    do {
        ...
        if (selection == 'P' || selection == 'p') {
            ...
            calculate_mean_from_list(numbers);
        } else if (selection == 'S' || selection == 's') {
            find_smallest_from_list(numbers);
        } else if (selection == 'L' || selection == 'l') {
            find_largest_from_list(numbers);
...
void add_number_to_list(vector<int> &list) {
    int num_to_add {};
    prompt_input("Enter an integer to add to the list: ", num_to_add);
